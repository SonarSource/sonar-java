...
public class JavaLexerTest {
  ...
  public void integer_literals() {
    ...
    assertThat(lexer.lex("543l"), hasToken("543l", JavaTokenType.INTEGER_LITERAL));
    assertThat(lexer.lex("543L"), hasToken("543L", JavaTokenType.INTEGER_LITERAL));

    // Hexadecimal
    assertThat(lexer.lex("0xFF"), hasToken("0xFF", JavaTokenType.INTEGER_LITERAL));
    assertThat(lexer.lex("0xFFl"), hasToken("0xFFl", JavaTokenType.INTEGER_LITERAL));
    assertThat(lexer.lex("0xFFL"), hasToken("0xFFL", JavaTokenType.INTEGER_LITERAL));
    ...
    assertThat(lexer.lex("077l"), hasToken("077l", JavaTokenType.INTEGER_LITERAL));
    assertThat(lexer.lex("077L"), hasToken("077L", JavaTokenType.INTEGER_LITERAL));

    // Binary (new in Java 7)
    assertThat(lexer.lex("0b1010"), hasToken("0b1010", JavaTokenType.INTEGER_LITERAL));
    assertThat(lexer.lex("0b1010l"), hasToken("0b1010l", JavaTokenType.INTEGER_LITERAL));
    assertThat(lexer.lex("0b1010L"), hasToken("0b1010L", JavaTokenType.INTEGER_LITERAL));
  ...
  public void underscore_in_numeric_literals() {
    ...
    assertThat(lexer.lex("0x7fff_ffff_ffff_ffffL"), hasToken("0x7fff_ffff_ffff_ffffL", JavaTokenType.INTEGER_LITERAL));
    assertThat(lexer.lex("3.14_15F"), hasToken("3.14_15F", JavaTokenType.FLOATING_LITERAL));
    assertThat(lexer.lex("1_234e1_0"), hasToken("1_234e1_0", JavaTokenType.FLOATING_LITERAL));
    assertThat(lexer.lex("0x1.ffff_ffff_ffff_fP1_023"), hasToken("0x1.ffff_ffff_ffff_fP1_023", JavaTokenType.FLOATING_LITERAL));
