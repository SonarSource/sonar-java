...
public class InternalVisitorsBridge {
  ...
  private boolean isNotJavaLangOrSerializable(String packageName) {
    ...
    return !("java/lang".equals(packageName)
      || isInPackageWithName("java/lang/annotation", "Annotation.java", packageName, name)
      || isInPackageWithName("java/io", "Serializable.java", packageName, name));
  }

  private static boolean isInPackageWithName(String expectedPackageName, String expectedName, String packageName, String name) {
    return expectedPackageName.equals(packageName) && expectedName.equals(name);
  }
