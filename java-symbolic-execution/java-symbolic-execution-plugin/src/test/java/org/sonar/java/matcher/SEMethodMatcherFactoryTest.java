...
class SEMethodMatcherFactoryTest {

  @Test
  void fail_arg() {
    try {
      SEMethodMatcherFactory.methodMatchers("org.sonar.test.Test$match");
    ...
    try {
      SEMethodMatcherFactory.constructorMatcher("   %");
      fail("Argument should not be accepted.");
    } catch (IllegalArgumentException iae) {
    ...
    try {
      SEMethodMatcherFactory.methodMatchers("org.sonar.test.Test#match(java.lang.String;int)");
      fail("Argument should not be accepted.");
    } catch (IllegalArgumentException iae) {
    ...
    try {
      SEMethodMatcherFactory.methodMatchers("org.sonar.test.Test#match(java.lang.String,int)followed by anything");
      fail("Argument should not be accepted.");
    } catch (IllegalArgumentException iae) {
      assertThat(iae.getMessage()).contains("constructor").contains("method");
    }
    try {
      SEMethodMatcherFactory.methodMatchers("org.sonar.test.Test#match this is an error");
      fail("Argument should not be accepted.");
    } catch (IllegalArgumentException iae) {
      assertThat(iae.getMessage()).contains("method");
    }
  ...
  @Test
  void inner_classes() {
    MethodMatchers anyArg = SEMethodMatcherFactory.methodMatchers("org.sonar.test.Outer$Inner#foo");
  ...
  void methodFactoryMatching() {
    MethodMatchers anyArg = SEMethodMatcherFactory.methodMatchers("org.sonar.test.Test#match");
    MethodMatchers stringOnly = SEMethodMatcherFactory.methodMatchers("org.sonar.test.Test#match(java.lang.String)");
    MethodMatchers stringInt = SEMethodMatcherFactory.methodMatchers("org.sonar.test.Test#match(java.lang.String,int)");
    MethodMatchers intInt = SEMethodMatcherFactory.methodMatchers("org.sonar.test.Test#match(int,int)");
    MethodMatchers onlyBoolean = SEMethodMatcherFactory.methodMatchers("org.sonar.test.Test#match(java.lang.Boolean)");
  ...
  void constructorFactoryMatching() {
    MethodMatchers anyArg = SEMethodMatcherFactory.constructorMatcher("java.lang.String");
    MethodMatchers noArg = SEMethodMatcherFactory.constructorMatcher("java.lang.String()");
    MethodMatchers stringBuilder = SEMethodMatcherFactory.constructorMatcher("java.lang.String(java.lang.StringBuilder)");
    MethodMatchers stringBytes = SEMethodMatcherFactory.constructorMatcher("java.lang.String(byte[],int,int)");
    MethodVisitor visitor = new MethodVisitor();
    visitor.add(anyArg);
    visitor.add(noArg);
