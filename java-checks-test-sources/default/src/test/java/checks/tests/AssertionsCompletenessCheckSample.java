...
public class AssertionsCompletenessCheckSample {
  @Rule
  ...
  public void fest_assertions() {
    ...
    org.fest.assertions.Assertions.assertThat(AssertionsCompletenessCheckSample.class.toString()).as("aa").hasSize(0); // Compliant
  }
