...
public class AssertJChainSimplificationCheckTest_QuickFix {
  void contextFreeQuickFixes() {
    assertThat(getString()).hasSize(0); // Noncompliant [[quickfixes=qf_context_free1]] {{Use isEmpty() instead.}}
//                          ^^^^^^^
    // fix@qf_context_free1 {{Use "isEmpty()"}}
    // edit@qf_context_free1 [[sc=29;ec=39]] {{isEmpty()}}
    assertThat(getObject()).isEqualTo(null); // Noncompliant [[quickfixes=qf_context_free2]] {{Use isNull() instead.}}
//                          ^^^^^^^^^
    // fix@qf_context_free2 {{Use "isNull()"}}
    // edit@qf_context_free2 [[sc=29;ec=44]] {{isNull()}}
    assertThat(getString().indexOf(12)).isLessThan(0); // Noncompliant [[quickfixes=qf_context_free3]] {{Use isNegative() instead.}}
//                                      ^^^^^^^^^^
  ...
  void withContextQuickFixes() {
    ...
    assertThat(getString().length()).isZero(); // Noncompliant [[quickfixes=qf_context1]] {{Use assertThat(actual).isEmpty() instead.}}
//                                   ^^^^^^
    // fix@qf_context1 {{Use "assertThat(actual).isEmpty()"}}
    // edit@qf_context1 [[sc=27;ec=36]] {{}}
    // edit@qf_context1 [[sc=38;ec=46]] {{isEmpty()}}

    assertThat(getFile().isAbsolute()).isFalse(); // Noncompliant [[quickfixes=qf_context2]] {{Use assertThat(actual).isRelative() instead.}}
//                                     ^^^^^^^
    ...
    assertThat(getString().matches(x)).isTrue(); // Noncompliant [[quickfixes=qf_context3]] {{Use assertThat(actual).matches(expected) instead.}}
//                                     ^^^^^^
    // fix@qf_context3 {{Use "assertThat(actual).matches(expected)"}}
    // edit@qf_context3 [[sc=27;ec=36]] {{).matches(}}
    // edit@qf_context3 [[sc=38;ec=48]] {{}}

    assertThat(getString().indexOf(x)).isEqualTo(-1); // Noncompliant [[quickfixes=qf_context4]] {{Use assertThat(actual).doesNotContain(expected) instead.}}
//                                     ^^^^^^^^^
    ...
    assertThat(getString().length()).isEqualTo(12); // Noncompliant [[quickfixes=qf_context5]] {{Use assertThat(actual).hasSize(expected) instead.}}
//                                   ^^^^^^^^^
    // fix@qf_context5 {{Use "assertThat(actual).hasSize(expected)"}}
    // edit@qf_context5 [[sc=27;ec=36]] {{}}
    // edit@qf_context5 [[sc=38;ec=47]] {{hasSize}}

    assertThat(getCollection().size()).isGreaterThan(length); // Noncompliant [[quickfixes=qf_context6]] {{Use assertThat(actual).hasSizeGreaterThan(expected) instead.}}
//                                     ^^^^^^^^^^^^^
    ...
    assertThat(getString().indexOf(x)).isEqualTo(0); // Noncompliant [[quickfixes=qf_context7]] {{Use isZero() instead.}}
//                                     ^^^^^^^^^
    ...
    assertThat(x.compareTo(y)).isPositive(); // Noncompliant [[quickfixes=qf_context8]] {{Use assertThat(actual).isGreaterThan(expected) instead.}}
//                             ^^^^^^^^^^
    ...
    assertThat(getArray().length).isPositive(); // Noncompliant [[quickfixes=qf_context9]] {{Use assertThat(actual).isNotEmpty() instead.}}
//                                ^^^^^^^^^^
    // fix@qf_context9 {{Use "assertThat(actual).isNotEmpty()"}}
    // edit@qf_context9 [[sc=26;ec=33]] {{}}
    // edit@qf_context9 [[sc=35;ec=47]] {{isNotEmpty()}}
    assertThat(getArray().length).isEqualTo(length); // Noncompliant [[quickfixes=qf_context10]] {{Use assertThat(actual).hasSize(expected) instead.}}
//                                ^^^^^^^^^
    ...
    assertThat(getCollection().size()).isGreaterThan(((length))); // Noncompliant [[quickfixes=qf_context11]] {{Use assertThat(actual).hasSizeGreaterThan(expected) instead.}}
//                                     ^^^^^^^^^^^^^
...
//                                   ^^^^^^^^^^
    ...
    assertThat(x.hashCode()).isEqualTo(y.hashCode()); // Noncompliant [[quickfixes=!]] {{Use assertThat(actual).hasSameHashCodeAs(expected) instead.}}
//                           ^^^^^^^^^
    assertThat(getMap().get(x)).isEqualTo(y); // Noncompliant [[quickfixes=!]] {{Use assertThat(actual).containsEntry(key, value) instead.}}
//                              ^^^^^^^^^
  }
