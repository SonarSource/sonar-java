...
class NonNullSetToNullCheckSample {
  ...
  public NonNullSetToNullCheckSample() { // Noncompliant [[sc=10;ec=31]] {{"primary" is marked "@Nonnull" but is not initialized in this constructor.}}
  ...
  public static void initialize1() {
    NonNullSetToNullCheckSample instance =
      new NonNullSetToNullCheckSample(null, "Blue");  // Noncompliant [[sc=7;ec=46]] {{Parameter 1 to this constructor is marked "@Nonnull" but null could be passed.}}
  }
