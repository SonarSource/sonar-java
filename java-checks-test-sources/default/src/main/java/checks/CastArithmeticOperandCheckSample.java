...
class CastArithmeticOperandCheckSample {
  ...
  void foo() {
    CastArithmeticOperandCheckSample a = new CastArithmeticOperandCheckSample(1 + 2, 1 + 2); // Noncompliant {{Cast one of the operands of this addition operation to a "long".}}
