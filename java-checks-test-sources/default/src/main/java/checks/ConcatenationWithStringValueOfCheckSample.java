...
class ConcatenationWithStringValueOfCheckSample {
  Object o;
  Object[] arr;
  ConcatenationWithStringValueOfCheckSample valueOf;

  private void f(int buf, ConcatenationWithStringValueOfCheckSample a) {
