...
abstract class DisallowedThreadGroupCheckSample
  ...
  void foo(
    ...
    ThreadGroup tg = // Noncompliant [[sc=5;ec=16]] {{Remove this use of "ThreadGroup". Prefer the use of "ThreadPoolExecutor".}}
      new ThreadGroup("DisallowedThreadGroupCheckSample"); // Compliant
...
class DisallowedThreadGroupCheckSampleB extends DisallowedThreadGroupCheckSample { // Compliant

  DisallowedThreadGroupCheckSampleB(ThreadGroup tg) {
    super(tg);
  }
  ...
  @Override
  void qix(Object o, boolean b) {
    ThreadGroup tg = new ThreadGroup("DisallowedThreadGroupCheckSampleB"); // Noncompliant
  }
}

class DisallowedThreadGroupCheckSampleC {
  Object foo() {
    Object o = new Object();
    return o;
  }
