...
class LeastSpecificTypeCheckSampleWithoutSemantic {

  public void test1(ArrayList<Object> list) { // Noncompliant
  ...
  public void test2(ArrayList<Object> list) { // Noncompliant
  ...
  public static void staticMethod(List<Object> list) { // Noncompliant
    list.size();
  }
  ...
  public void test4(C arg) { // Noncompliant
    arg.a();
    arg.b();
  }
  ...
  public static void enhancedForLoop(List<Object> list) { // Noncompliant
    for (Object o : list) {
      o.toString();
    }
  }
  ...
  public static void coverage(PrivateClass c) { // Noncompliant
    c.b2();
  }
