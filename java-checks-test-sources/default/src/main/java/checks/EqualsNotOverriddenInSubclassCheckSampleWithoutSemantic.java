...
class EqualsNotOverriddenInSubclassCheckSampleWithoutSemantic {
...
//      ^
  ...
  // Without semantic, reflectionEquals usage in parent cannot be detected, so this is a false positive
  class ReflectionEqualsChildLang3 extends ReflectionEqualsParentLang3 { // Noncompliant
    String name2;
  }

  // Without semantic, external parent type cannot be resolved
  class ChildOfExternalParent extends EqualsNotOverriddenExternalParent {
    String name2;
  }
  ...
  // Without semantic, reflectionEquals usage in parent cannot be detected, so this is a false positive
  class ReflectionEqualsChildLang extends ReflectionEqualsParentLang { // Noncompliant
    String name2;
  }
