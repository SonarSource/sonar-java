...
public abstract class InstanceOfPatternMatchingWithoutSemantic {

  private static String booleanArray(Object o){
    if(o instanceof boolean[]){ // Noncompliant
  ...
  int if2(Object o) {
    if (1 > 2 && o instanceof String && 3 > 4) { // Noncompliant
  ...
  int if5(Map<String, Object> map) {
    if (map.get("hello") instanceof String) { // Noncompliant
  ...
  int ifElse3(Object o) {
    if (!(o instanceof String || 1 < 2)) { // Noncompliant
  ...
  void whileLoop1() {
    Object o = getNext();
    while (o instanceof String) { // Noncompliant
  ...
  void forLoop1() {
    for (Object o = getNext(); o instanceof String; o = getNext()) { // Noncompliant
