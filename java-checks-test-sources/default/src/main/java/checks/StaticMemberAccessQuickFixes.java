...
class StaticMemberAccessQuickFixes {
  ...
  static class InnerClass extends StaticMemberAccessQuickFixes {
    ...
    void bar() {
      InnerClass.counter++; // Noncompliant [[quickfixes=qf1]] {{Use static access with "checks.StaticMemberAccessQuickFixes" for "counter".}}
//               ^^^^^^^
  ...
  static class SecondInnerClass extends InnerClass {
    void qix() {
      SecondInnerClass.otherCounter++; // Noncompliant [[quickfixes=qf2]] {{Use static access with "checks.StaticMemberAccessQuickFixes$InnerClass" for "otherCounter".}}
//                     ^^^^^^^^^^^^
...
class StaticMemberAccessQuickFixesChild extends StaticMemberAccessQuickFixes {
  void bar() {
    StaticMemberAccessQuickFixesChild.counter++; // Noncompliant [[quickfixes=qf3]] {{Use static access with "checks.StaticMemberAccessQuickFixes" for "counter".}}
//                                    ^^^^^^^
    ...
    StaticMemberAccessQuickFixesChild.foo(); // Noncompliant [[quickfixes=qf4]] {{Use static access with "checks.StaticMemberAccessQuickFixes" for "foo".}}
//                                    ^^^
