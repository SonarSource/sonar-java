...
class CollectionIsEmptyCheckSample {
  int[] size = new int[4];

  private void foo(Collection myCollection, Collection myCollection2, CollectionIsEmptyCheckSample foo, ByteArrayOutputStream baot) {
    boolean b;
    int i;
