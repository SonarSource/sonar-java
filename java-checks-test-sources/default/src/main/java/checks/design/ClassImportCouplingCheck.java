...
class ClassImportCouplingCheck { // Noncompliant {{Split this “Monster Class” into smaller and more specialized ones to reduce its dependencies on other classes from 23 to the maximum authorized 20 or less.}}
//    ^^^^^^^^^^^^^^^^^^^^^^^^
