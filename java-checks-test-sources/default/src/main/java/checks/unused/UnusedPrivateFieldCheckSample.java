...
class UnusedPrivateFieldCheckSample {
...
enum UnusedPrivateFieldCheckSampleFooEnum {

  FOO;

}

interface UnusedPrivateFieldCheckSampleFooInterface {

  int FOO = 0; // Compliant

}

class UnusedPrivateFieldCheckSampleSpecialAnnotations {
...
class UnusedPrivateFieldCheckSampleTestSonar {
...
class UnusedPrivateFieldCheckSampleQuickfix {
