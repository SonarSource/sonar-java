...
class AndroidMobileDatabaseEncryptionKeysCheckSample {
...
//  ^^^<
    ...
    database = SQLiteDatabase.openOrCreateDatabase(databasePath, password, null, hook); // Noncompliant {{The "password" parameter should not be hardcoded.}}
//                                                               ^^^^^^^^
