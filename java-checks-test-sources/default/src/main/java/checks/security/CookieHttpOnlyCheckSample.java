...
class CookieHttpOnlyCheckSampleCookieA extends Cookie {
  public Cookie c;

  public CookieHttpOnlyCheckSampleCookieA() {
    super("name", "value");
  }
...
class CookieHttpOnlyCheckSampleCookieB {
  CookieHttpOnlyCheckSampleCookieA a;
  ...
  CookieHttpOnlyCheckSampleCookieA getA() {
    return new CookieHttpOnlyCheckSampleCookieA(); // Noncompliant
  }
...
class JakartaCookieHttpOnlyCheckSampleCookieACookieHttpOnlyCheckSample {
...
class JakartaCookieHttpOnlyCheckSampleCookieA extends jakarta.servlet.http.Cookie {
  public jakarta.servlet.http.Cookie c;

  public JakartaCookieHttpOnlyCheckSampleCookieA() {
    super("name", "value");
  }
...
class JakartaCookieHttpOnlyCheckSampleCookieB {
  JakartaCookieHttpOnlyCheckSampleCookieA a;
  ...
  JakartaCookieHttpOnlyCheckSampleCookieA getC() {
    return new JakartaCookieHttpOnlyCheckSampleCookieA(); // Noncompliant
  }
