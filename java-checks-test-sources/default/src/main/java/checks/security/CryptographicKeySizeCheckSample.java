...
class CryptographicKeySizeCheckSampleRSA {
...
class CryptographicKeySizeCheckSampleRSA2 {
  KeyPairGenerator keyGen = KeyPairGenerator.getInstance("RSA");

  CryptographicKeySizeCheckSampleRSA2() throws NoSuchAlgorithmException {}
  ...
  public void key_variable_instance() throws NoSuchAlgorithmException {
    CryptographicKeySizeCheckSampleRSA2 rsa2 = new CryptographicKeySizeCheckSampleRSA2();
...
interface CryptographicKeySizeCheckSampleI {
  Runnable r = () -> {
    try {
      KeyPairGenerator keyGen = KeyPairGenerator.getInstance("RSA");
...
class CryptographicKeySizeCheckSampleDH {
...
class CryptographicKeySizeCheckSampleDSA {
...
class CryptographicKeySizeCheckSampleAES {
  public void key_variable() throws NoSuchAlgorithmException {
...
class CryptographicKeySizeCheckSampleEC {
