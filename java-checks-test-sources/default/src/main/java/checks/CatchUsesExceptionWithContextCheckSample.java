...
import static checks.CatchUsesExceptionWithContextCheckSample.MyCustomLogger.staticallyImportedMethod;
import static checks.CatchUsesExceptionWithContextCheckSample.Provider.staticallyImportedMethodFromProvider;

class CatchUsesExceptionWithContextCheckSample {
