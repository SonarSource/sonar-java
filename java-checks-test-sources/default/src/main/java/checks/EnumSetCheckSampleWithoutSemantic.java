...
class EnumSetCheckSampleWithoutSemantic {
  ...
  public void doSomething(Set<COLOR> param) { // compliant, we ignore parameters.
    ...
    Set<COLOR> ports6 = Sets.newHashSet(COLOR.RED); // FN
    ...
    Set<COLOR> col5 = ImmutableSet.<COLOR>of(); // FN
    Set<COLOR> col6 = ImmutableSet.of(COLOR.RED, COLOR.ORANGE); // FN
    Set<COLOR> col7 = ImmutableSet.of(COLOR.RED, COLOR.BLUE, COLOR.RED, COLOR.ORANGE, COLOR.GREEN, COLOR.ORANGE, COLOR.BLUE); // FN
