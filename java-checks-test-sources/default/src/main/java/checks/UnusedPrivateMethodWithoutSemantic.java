...
class UnusedPrivateMethodCheckWS {
  ...
  private static Stream<String> testMessages() { // Noncompliant
  ...
  private int unusedPrivateMethod(int a, String s) { // Noncompliant
    return 1;
  }
  ...
  public enum Attribute {
    ...
    Attribute(String prettyName, String[][] martrix, int i) { // Noncompliant
    }
  ...
  private void testQuickFix1() { // Noncompliant
  ...
  private void testQuickFix2() { // Noncompliant
