...
class VolatileNonPrimitiveFieldCheckSample {
  ...
  private volatile VolatileNonPrimitiveFieldCheckSampleObj myObj;  // Noncompliant [[sc=11;ec=59]] {{Use a thread-safe type; adding "volatile" is not enough to make this field thread-safe.}}
  ...
  private VolatileNonPrimitiveFieldCheckSampleObj myObj2;
  // enums are considered as immutable
  private volatile DayOfWeek myDayOfWeek;
  private volatile Month myMonth;
  private volatile VolatileNonPrimitiveFieldCheckSampleEnum myEnum;
  ...
  private volatile VolatileNonPrimitiveFieldCheckSampleImmutable immutable;
  private volatile VolatileNonPrimitiveFieldCheckSampleThreadSafe threadSafe;
  // Not thread safe
  private volatile VolatileNonPrimitiveFieldCheckSampleNotThreadSafe notThreadSafe; // Noncompliant

  void foo(){}
}
enum VolatileNonPrimitiveFieldCheckSampleEnum {
  FOO;
  private volatile int vInts0;
  private volatile int [] vInts;  // Noncompliant [[sc=11;ec=26]] {{Use an "AtomicIntegerArray" instead.}}
  private volatile VolatileNonPrimitiveFieldCheckSampleObj myObj;  // Noncompliant [[sc=11;ec=59]] {{Use a thread-safe type; adding "volatile" is not enough to make this field thread-safe.}}
...
class VolatileNonPrimitiveFieldCheckSampleObj {

}

@javax.annotation.concurrent.Immutable
class VolatileNonPrimitiveFieldCheckSampleImmutable {
}

@javax.annotation.concurrent.ThreadSafe
class VolatileNonPrimitiveFieldCheckSampleThreadSafe {
}

@javax.annotation.concurrent.NotThreadSafe
class VolatileNonPrimitiveFieldCheckSampleNotThreadSafe {
}
