...
class BigDecimalDoubleConstructorCheckSample {
  ...
  BigDecimal bd2 = new BigDecimal(2.0); // Noncompliant [[quickfixes=qf1]] {{Use "BigDecimal.valueOf" instead.}}
//                 ^^^^^^^^^^^^^^^^^^^
  // fix@qf1 {{Replace with BigDecimal.valueOf}}
  // edit@qf1 [[sc=20;ec=34]] {{BigDecimal.valueOf}}
  BigDecimal bd4 = new BigDecimal(2.0, mc); // Noncompliant [[quickfixes=qf1_2]] {{Use "new BigDecimal(String, MathContext)" instead.}}
//                 ^^^^^^^^^^^^^^^^^^^^^^^
  // fix@qf1_2 {{Replace with BigDecimal("2.0",}}
  // edit@qf1_2 [[sc=35;ec=38]] {{"2.0"}}
  BigDecimal bd43 = new BigDecimal(123.0, mc); // Noncompliant [[quickfixes=qf1_3]] {{Use "new BigDecimal(String, MathContext)" instead.}}
//                  ^^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  BigDecimal bd6 = new BigDecimal(2.0f, mc); // Noncompliant [[quickfixes=qf1_4]] {{Use "new BigDecimal(String, MathContext)" instead.}}
//                 ^^^^^^^^^^^^^^^^^^^^^^^^
  // fix@qf1_4 {{Replace with BigDecimal("2.0",}}
  // edit@qf1_4 [[sc=35;ec=39]] {{"2.0"}}

  BigDecimal bd6_2 = new BigDecimal(2.0d, mc); // Noncompliant [[quickfixes=qf1_5]] {{Use "new BigDecimal(String, MathContext)" instead.}}
//                   ^^^^^^^^^^^^^^^^^^^^^^^^
  // fix@qf1_5 {{Replace with BigDecimal("2.0",}}
  // edit@qf1_5 [[sc=37;ec=41]] {{"2.0"}}

  BigDecimal bd6_3 = new BigDecimal(2.0F, mc); // Noncompliant [[quickfixes=qf1_6]] {{Use "new BigDecimal(String, MathContext)" instead.}}
//                   ^^^^^^^^^^^^^^^^^^^^^^^^
  // fix@qf1_6 {{Replace with BigDecimal("2.0",}}
  // edit@qf1_6 [[sc=37;ec=41]] {{"2.0"}}

  BigDecimal bd6_4 = new BigDecimal(2.0D, mc); // Noncompliant [[quickfixes=qf1_7]] {{Use "new BigDecimal(String, MathContext)" instead.}}
//                   ^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  BigDecimal bd8_3 = new BigDecimal(d, mc); // Noncompliant [[quickfixes=!]] {{Use "new BigDecimal(String, MathContext)" instead.}}
//                   ^^^^^^^^^^^^^^^^^^^^^
  ...
  BigDecimal bd10_2 = new BigDecimal((float) 0.1); // Noncompliant [[quickfixes=qf2]]
//                    ^^^^^^^^^^^^^^^^^^^^^^^^^^^
