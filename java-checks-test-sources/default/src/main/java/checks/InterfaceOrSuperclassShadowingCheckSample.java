...
abstract class Serializable implements java.io.Serializable {} // Noncompliant {{Rename this class.}}
//             ^^^^^^^^^^^^

abstract class MyFlushable implements java.io.Flushable {}
abstract class Flushable extends MyFlushable {}

record Function<T, R> () implements java.util.function.Function { // Noncompliant {{Rename this record.}}
//     ^^^^^^^^
