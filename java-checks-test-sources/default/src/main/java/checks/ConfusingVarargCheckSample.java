...
class ConfusingVarargCheckSample {
  ...
  void reflection(int[] ints) throws Exception {
    Method method = ConfusingVarargCheckSample.class.getMethod("foo", null); // Compliant
    method.invoke(this, null); // Compliant

    ConfusingVarargCheckSample.class.getConstructors()[0].newInstance(null); // Compliant
