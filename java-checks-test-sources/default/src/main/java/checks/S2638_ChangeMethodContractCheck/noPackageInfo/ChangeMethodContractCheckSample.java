...
class ChangeMethodContractCheckSample_B extends ChangeMethodContractCheckSample {
  @Override
...
class ChangeMethodContractCheckSample_C extends ChangeMethodContractCheckSample {
  @Override
 ...
 */
class ChangeMethodContractCheckSample_WithMetaAnnotations {
 ...
 */
class ChangeMethodContractCheckSample_NonnullWithArguments {

  class Parent {
    @javax.validation.constraints.NotNull(groups = { ChangeMethodContractCheckSample.class })
    String annotatedNotNullWithArg(Object a) { return "null"; }

    @javax.validation.constraints.NotNull
    String annotatedNotNullWithoutArg(Object a) { return "null"; }

    void argAnnotatedNoNullWithArg(@javax.validation.constraints.NotNull(groups = { ChangeMethodContractCheckSample.class }) Object a) { }
 ...
 */
class ChangeMethodContractCheckSample_NullableViaNonnull {
...
class ChangeMethodContractCheckSample_FromExternalDependency {
