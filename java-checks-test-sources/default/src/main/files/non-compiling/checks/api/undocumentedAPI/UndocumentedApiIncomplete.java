 ...
 * FIXME
 */
public class A { } // Noncompliant {{Document this public class by adding an explicit description.}}

/**
 * .
 */
public class B { } // Noncompliant {{Document this public class by adding an explicit description.}}

/**
 * ...
 */
public class C { } // Noncompliant {{Document this public class by adding an explicit description.}}

/**
 * TODO
 */
public class D { } // Noncompliant {{Document this public class by adding an explicit description.}}

/**
 *
 */
public class E { } // Noncompliant {{Document this public class by adding an explicit description.}}
...
public class H { } // Noncompliant {{Document this public class by adding an explicit description.}}
...
public class Parameters {
   ...
   * @param sab
   */
  public void foo(String s, Object o) { } // Noncompliant {{Document the parameter(s): s, o}}
   ...
   * @param o FIXME
   */
  public void foo(Object o) { } // Noncompliant {{Document the parameter(s): o}}

  /**
   * This is documented
   * @param l .
   */
  public void foo(long l) { } // Noncompliant {{Document the parameter(s): l}}
   ...
   */
  public void foo(double d) { } // Noncompliant {{Document this public method by adding an explicit description.}}
...
public class ReturnValue {
   ...
   * @return
   */
  public String bar1() { } // Noncompliant {{Document this public method by adding an explicit description.}}
   ...
   * @return FIXME
   */
  public String bro() { } // Noncompliant {{Document this method return value.}}
