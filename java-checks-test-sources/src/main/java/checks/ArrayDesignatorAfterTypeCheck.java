...
class ArrayDesignatorAfterTypeCheck {
  ...
  public int getVector()[] { return new int[0]; }    // Noncompliant [[sc=25;ec=26;quickfixes=qf1]] {{Move the array designators "[]" to the end of the return type.}}
  // fix@qf1 {{Move [] to the return type}}
  // edit@qf1 [[sc=25;ec=27]] {{}}
  // edit@qf1 [[sc=13;ec=13]] {{[]}}

  public List<String> getList()[] { return null; } // Noncompliant [[sc=32;ec=33;quickfixes=qf2]]
  ...
  public int foo()[][][][] { return new int[0][][][]; }    // Noncompliant {{Move the array designators "[]" to the end of the return type.}}
