  ...
  public void foo(java.util.Properties props) {
    ...
    */
    ...
    try {
      ...
      Cipher.getInstance("AES" + "/ECB/NoPadding"); // Noncompliant {{Use a secure cipher mode.}}
      Cipher.getInstance("AES/ECB/NoPadding", getProvider()); // Noncompliant {{Use a secure cipher mode.}}
      Cipher.getInstance("AES/ECB/NoPadding", "someProvider"); // Noncompliant {{Use a secure cipher mode.}}

      Cipher.getInstance("Blowfish/ECB/PKCS5Padding"); // Noncompliant {{Use a secure cipher mode.}}
      Cipher.getInstance("DES/ECB/PKCS5Padding"); // Noncompliant {{Use a secure cipher mode.}}
      ...
      Cipher.getInstance(algoUpperCase); // Noncompliant {{Use a secure cipher mode.}}
