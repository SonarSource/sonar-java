...
class DivisionByZeroCheck {
  ...
  void flow_through_binary_expression_keep_track_of_the_inceptive_symbol(boolean condition, int unknownInt) {
    ...
    int divisorAncestor5 = // flow@inceptive_symbol [[order=2]] {{Implies 'divisorAncestor5' has the same value as 'divisorAncestor6'.}}
      divisorAncestor6 / unknownInt;
    int divisorAncestor4 = // flow@inceptive_symbol [[order=3]] {{Implies 'divisorAncestor4' has the same value as 'divisorAncestor5'.}}
      divisorAncestor5 % unknownInt;
    int divisorAncestor3 = // flow@inceptive_symbol [[order=4]] {{Implies 'divisorAncestor3' has the same value as 'divisorAncestor4'.}}
      divisorAncestor4 * unknownInt;
    int divisorAncestor2 = // flow@inceptive_symbol [[order=5]] {{Implies 'divisorAncestor2' has the same value as 'divisorAncestor3'.}}
      unknownInt * divisorAncestor3;
    int divisorAncestor1 = // flow@inceptive_symbol [[order=6]] {{Implies 'divisorAncestor1' has the same value as 'divisorAncestor2'.}}
      0 + divisorAncestor2;
