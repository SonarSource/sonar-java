...
public class UnsupportedNullability {
  ...
  public Object id1001_type_NO_ANNOTATION_level_PACKAGE(
    ...
    Object id1005_type_UNKNOWN_level_UNKNOWN = new Object();
    try (InputStream id1006_type_UNKNOWN_level_UNKNOWN = null) {

    } catch (IOException id1007_type_UNKNOWN_level_UNKNOWN) {

    }
    // and the direct annotations are not yet supported on local variables
    @Nonnull
    Object id1008_type_UNKNOWN_level_UNKNOWN = new Object();
    return id1008_type_UNKNOWN_level_UNKNOWN;
  }
