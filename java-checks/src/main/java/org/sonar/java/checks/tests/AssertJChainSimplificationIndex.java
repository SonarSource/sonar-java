...
public class AssertJChainSimplificationIndex {
  ...
  static final Map<String, List<SimplifierWithContext>> SIMPLIFIERS_WITH_CONTEXT = MapBuilder.<String, List<AssertJChainSimplificationCheck.SimplifierWithContext>>newMap()
    ...
    .put(IS_FALSE, Arrays.asList(
      ...
      withSubjectArgumentCondition(arg -> arg.is(Tree.Kind.LESS_THAN), msgWithActualExpected(IS_LESS_THAN)),
      withSubjectArgumentCondition(arg -> arg.is(Tree.Kind.LESS_THAN_OR_EQUAL_TO), msgWithActualExpected(IS_LESS_THAN_OR_EQUAL_TO)),
      withSubjectArgumentCondition(arg -> arg.is(Tree.Kind.GREATER_THAN), msgWithActualExpected(IS_GREATER_THAN)),
      withSubjectArgumentCondition(arg -> arg.is(Tree.Kind.GREATER_THAN_OR_EQUAL_TO), msgWithActualExpected(IS_GREATER_THAN_OR_EQUAL_TO)),
