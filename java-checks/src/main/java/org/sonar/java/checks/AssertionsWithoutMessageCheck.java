...
public class AssertionsWithoutMessageCheck extends AbstractMethodDetection {
  ...
  private static final MethodInvocationMatcher festAsMethod = MethodInvocationMatcher.create()
  ...
  protected void onMethodFound(MethodInvocationTree mit) {
    if(mit.symbol().owner().type().isSubtypeOf("org.fest.assertions.GenericAssert") && !festAsMethod.matches(mit)) {
  ...
  private static class FestVisitor extends BaseTreeVisitor {
    ...
    public void visitMethodInvocation(MethodInvocationTree tree) {
      useDescription |= festAsMethod.matches(tree);
