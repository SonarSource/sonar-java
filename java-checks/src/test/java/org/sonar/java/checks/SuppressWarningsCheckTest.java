...
public class SuppressWarningsCheckTest {
  ...
  @Test
  public void empty_list_of_warnings_then_any_suppressWarnings_is_an_issue() {
  ...
  @Test
  public void list_of_warnings_with_syntax_error_then_any_suppressWarnings_is_an_issue() {
    CheckMessagesVerifier.verify(getSourceFile("   ,   , ,,").getCheckMessages())
      .next().atLine(1).withMessage("Suppressing warnings is not allowed")
      .next().atLine(6)
      .next().atLine(10)
  ...
  @Test
  public void only_one_warning_is_not_allowed() {
  ...
  @Test
  public void only_one_warning_is_allowed() {
    CheckMessagesVerifier.verify(getSourceFile("unchecked", true).getCheckMessages())
  ...
  @Test
  public void warning_based_on_constants_are_ignored() {
  ...
  @Test
  public void two_warnings_from_different_lines_are_not_allowed() {
  ...
  @Test
  public void two_warnings_from_same_line_are_not_allowed() {
  ...
  private SourceFile getSourceFile(String listOfWarnings) {
    return getSourceFile(listOfWarnings, false);
  }

  private SourceFile getSourceFile(String listOfWarnings, boolean whitelistModeEnabled) {
    SuppressWarningsCheck check = new SuppressWarningsCheck();
    check.warningsCommaSeparated = listOfWarnings;
    check.whitelistModeEnabled = whitelistModeEnabled;
