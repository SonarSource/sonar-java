...
public class UselessConditionCheckTest {
  ...
  public void test() {
    ...
    checkMessagesVerifier.verify(file.getCheckMessages())
      ...
      .next().atLine(277).withMessage("Change this condition so that it does not always evaluate to \"false\"")
      ...
      .next().atLine(314).withMessage("Change this condition so that it does not always evaluate to \"false\"")
