...
public class NullPointerCheckTest {
  ...
  public void check() {
    ...
    checkMessagesVerifier.verify(file.getCheckMessages())
      ...
      .next().atLine(91).withMessage("NullPointerException might be thrown as 'array2' is nullable here")
      .next().atLine(93).withMessage("NullPointerException might be thrown as 'nullableMethod' is nullable here")
      ...
      .next().atLine(227).withMessage("NullPointerException might be thrown as 'var2' is nullable here")
      ...
      .next().atLine(278).withMessage("NullPointerException might be thrown as 'object' is nullable here")
      .next().atLine(283).withMessage("NullPointerException might be thrown as 'object' is nullable here")
      .next().atLine(284).withMessage("NullPointerException might be thrown as 'object' is nullable here")
      ...
      .next().atLine(304).withMessage("NullPointerException might be thrown as 'object1' is nullable here")
      .next().atLine(306).withMessage("NullPointerException might be thrown as 'object2' is nullable here")
      .next().atLine(308).withMessage("NullPointerException might be thrown as 'object1' is nullable here")
      .next().atLine(333).withMessage("NullPointerException might be thrown as 'str' is nullable here")
      .next().atLine(335).withMessage("NullPointerException might be thrown as 'str' is nullable here")
      .next().atLine(337).withMessage("NullPointerException might be thrown as 'str' is nullable here")
      .next().atLine(352).withMessage("NullPointerException might be thrown as 'object' is nullable here")
