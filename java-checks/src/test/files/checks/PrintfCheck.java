...
class A {
  void foo(){
    ...
    String.format("value is " + value); // non-compliant : string concatenation in argument.
    String.format("string without arguments"); // non-compliant
    ...
    pr.format("string without arguments"); // non-compliant
    pr.format(loc, "string without arguments"); // non-compliant
    pr.printf("string without arguments"); // non-compliant
    pr.printf(loc, "string without arguments"); // non-compliant
    ps.format("string without arguments"); // non-compliant
    ps.format(loc, "string without arguments"); // non-compliant
    ps.printf("string without arguments"); // non-compliant
    ps.printf(loc, "string without arguments"); // non-compliant
    formatter.format("string without arguments"); // non-compliant
    formatter.format(loc, "string without arguments"); // non-compliant
    
    pr.format("value is " + value); // non-compliant
    pr.format(loc, "value is " + value); // non-compliant
    pr.printf("value is " + value); // non-compliant
    pr.printf(loc, "value is " + value); // non-compliant
    ps.format("value is " + value); // non-compliant
    ps.format(loc, "value is " + value); // non-compliant
    ps.printf("value is " + value); // non-compliant
    ps.printf(loc, "value is " + value); // non-compliant
    formatter.format("value is " + value); // non-compliant
    formatter.format(loc, "value is " + value); // non-compliant
