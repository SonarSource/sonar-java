...
class A {
  ...
  Cookie servletCookie(
    ...
    Cookie cookie5 = new Cookie("name", "value"); // Noncompliant, previously FN
  ...
  HttpCookie getHttpCookie() {
    ...
    HttpCookie c4 = new HttpCookie("name", "value"); // Noncompliant, previously FN
