class CognitiveComplexityCheck {
  ...
  public int ternaryOp(int a, int b) { // FN
  ...
  public boolean extraConditions() { // FN
    return a && b || foo(b && c);
  }
  public boolean extraConditions2() { // FN
    return a && (b || c) || d;
  }
  public void extraConditions3() { // FN
    if (a && b || c || d) {}
  }
  public void extraConditions4() { // FN
    if (a && b || c && d || e) {}
  }
  public void extraConditions5() { // FN
    if (a || b && c || d && e) {}
  }
  public void extraConditions6() { // FN
    if (a && b && c || d || e) {}
  }
  public void extraConditions7() { // FN
    if (a) {}
  }
  public void extraConditions8() { // FN
    if (a && b && c && d && e) {}
  }
  public void extraConditions9() { // FN
      if (a || b || c || d || e) {}
  }
  public void extraCondition10() { // FN
    if (a && b && c || d || e && f){}
  }


  public void switch2(){ // FN
  ...
  public void extraCondition11() { // FN
    if (a || (b || c)) {}
  }

  public void extraConditions12() { // FN
  ...
  public void breakWithLabel(java.util.Collection<Boolean> objects) { // FN
    doABarrelRoll:
  ...
  public void doFilter(ServletRequest servletRequest) { // FN
  ...
  static boolean enforceLimits(BoundTransportAddress boundTransportAddress) { // FN
  ...
  String bulkActivate(Iterator<String> rules) { // FN
  ...
  private static String getValueToEval( Measure.Level alertLevel, Color foo ) { // FN
  ...
  boolean isPalindrome(char [] s, int len) { // FN
  ...
  int sumOfNonPrimes(int limit) { // FN
  ...
  public static HighlightingType toProtocolType(TypeOfText textType) { // FN
  ...
  void noNestingForIfElseIf() { // Noncompliant
    while (true) { // +1
      if (true) { // +2 (nesting=1)
        for (;;) { // +3 (nesting=2)
          if (true) { // +4 (nesting=3)
