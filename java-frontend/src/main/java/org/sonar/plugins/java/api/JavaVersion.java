...
public interface JavaVersion {
   ...
   * Remark - Contrary to other isJava*Compatible methods, this one will NOT return true if version is not set
   * @return true if java version used is >= 120
   * @since SonarJava 8.0: Support of Java 20
   */
   ...
   * Remark - Contrary to other isJava*Compatible methods, this one will NOT return true if version is not set
   * @return true if java version used is >= 21
   * @since SonarJava 8.0: Support of Java 21
   */
   ...
   * Remark - Contrary to other isJava*Compatible methods, this one will NOT return true if version is not set
   * @return true if java version used is >= 22
   * @since SonarJava 8.0: Support of Java 22
   */
  ...
  /**
   * Test if java version of the project is greater than or equal to 24.
   * Remark - Contrary to other isJava*Compatible methods, this one will NOT return true if version is not set
   * @return true if java version used is >= 24
   * @since SonarJava 8.0: Support of Java 24
   */
  boolean isJava24Compatible();

  /**
   * Test if java version of the project is greater than or equal to 25.
   * Remark - Contrary to other isJava*Compatible methods, this one will NOT return true if version is not set
   * @return true if java version used is >= 25
   * @since SonarJava 8.10: Support of Java 25
   */
