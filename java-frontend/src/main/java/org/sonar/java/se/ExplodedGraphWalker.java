...
public class ExplodedGraphWalker {
  ...
  @VisibleForTesting
  public ExplodedGraphWalker(BehaviorCache behaviorCache, ISemanticModel semanticModel) {
  ...
  @VisibleForTesting
  ExplodedGraphWalker(BehaviorCache behaviorCache, ISemanticModel semanticModel, boolean cleanup) {
    this(behaviorCache, semanticModel);
    this.cleanup = cleanup;
  }

  @VisibleForTesting
  protected ExplodedGraphWalker(List<SECheck> seChecks, BehaviorCache behaviorCache, ISemanticModel semanticModel) {
    this.alwaysTrueOrFalseExpressionCollector = new AlwaysTrueOrFalseExpressionCollector();
  ...
  public static class ExplodedGraphWalkerFactory {
    ...
    public ExplodedGraphWalker createWalker(BehaviorCache behaviorCache, ISemanticModel semanticModel) {
