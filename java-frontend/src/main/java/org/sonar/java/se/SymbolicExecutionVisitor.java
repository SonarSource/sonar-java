...
import org.sonar.java.se.symbolicvalues.RelationalSymbolicValue.TransitiveRelationExceededException;
...
public class SymbolicExecutionVisitor extends SubscriptionVisitor {
  ...
  public MethodBehavior execute(MethodTree methodTree) {
    ...
    } catch (ExplodedGraphWalker.MaximumStepsReachedException | ExplodedGraphWalker.ExplodedGraphTooBigException | TransitiveRelationExceededException exception) {
