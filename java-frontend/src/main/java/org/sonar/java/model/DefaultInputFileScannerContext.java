...
public class DefaultInputFileScannerContext extends DefaultScannerContext implements InputFileScannerContext {
  ...
  public DefaultInputFileScannerContext(@Nullable SonarComponents sonarComponents, InputFile inputFile, JavaVersion javaVersion, boolean inAndroidContext,
    ...
    super(sonarComponents, javaVersion, cacheContext);
