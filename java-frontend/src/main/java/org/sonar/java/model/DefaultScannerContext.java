...
public class DefaultScannerContext implements ScannerContext {
  ...
  public DefaultScannerContext(@Nullable SonarComponents sonarComponents, JavaVersion javaVersion, @Nullable CacheContext cacheContext) {
