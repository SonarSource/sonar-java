...
public interface MetricsScannerContext {
  ...
  class MetricsComputer {
    ...
    private Map<Integer, Integer> methodNumberOfAccessedVariables = new HashMap<>();
    private Map<Integer, Integer> treeLinesOfCode = new HashMap<>();
    private Map<Integer, Integer> treeNumberOfStatements = new HashMap<>();
    private Map<Integer, Integer> treeNumberOfCommentedLines = new HashMap<>();
    private Map<Integer, Set<Integer>> treeNoSonarLines = new HashMap<>();
    private Map<Integer, Integer> methodNestingLevel = new HashMap<>();
