...
public class SECheckTest {
  ...
  public void flow_from_exit_node_should_not_lead_to_infinite_recursion() throws Exception {
    ...
    ExplodedGraph.Node node = new ExplodedGraph.Node(new ProgramPoint(cfg.blocks().get(3), 0), mock(ProgramState.class));
    node.addParent(new ExplodedGraph.Node(new ProgramPoint(cfg.blocks().get(2), 2), mock(ProgramState.class)), null);
