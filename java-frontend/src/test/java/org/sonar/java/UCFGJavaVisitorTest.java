...
public class UCFGJavaVisitorTest {
  ...
  public void field_access_on_method_call() {
    ...
    assertCodeToUCfg("class A {\n" +
        ...
        "  String baz(A[] array) { return array[0].field; }\n" +
        "}\n", expectedUCFG);
  }
