...
class InternalSyntaxTriviaTest {
  ...
  void single_line_comment() {
    ...
    assertThat(trivia.isLineComment()).isTrue();
    assertThat(trivia.isBlockComment()).isFalse();
    assertThat(trivia.isJavadocComment()).isFalse();
    assertThat(trivia.isMarkdownComment()).isFalse();
    assertThat(trivia.isJavadocOrMarkdownComment()).isFalse();
  ...
  void multi_line_comment() {
    ...
    assertThat(trivia.isLineComment()).isFalse();
    assertThat(trivia.isBlockComment()).isTrue();
    assertThat(trivia.isJavadocComment()).isFalse();
    assertThat(trivia.isMarkdownComment()).isFalse();
    assertThat(trivia.isJavadocOrMarkdownComment()).isFalse();
    assertThat(trivia.startLine()).isEqualTo(42);
  ...
  void javadoc_comment() {
    ...
    assertThat(trivia.isLineComment()).isFalse();
    assertThat(trivia.isBlockComment()).isFalse();
    assertThat(trivia.isJavadocComment()).isTrue();
    assertThat(trivia.isMarkdownComment()).isFalse();
    assertThat(trivia.isJavadocOrMarkdownComment()).isTrue();
    assertThat(trivia.startLine()).isEqualTo(42);
    assertThat(trivia.column()).isEqualTo(21);
  ...
  void markdown_comment() {
    ...
    assertThat(trivia.isBlockComment()).isFalse();
    assertThat(trivia.isJavadocComment()).isFalse();
    assertThat(trivia.isMarkdownComment()).isTrue();
    assertThat(trivia.isJavadocOrMarkdownComment()).isTrue();
    assertThat(trivia.startLine()).isEqualTo(42);
    assertThat(trivia.column()).isEqualTo(21);
