...
class JParserConfigTest {
  ...
  @Test
  void a_debug_message_is_logged_when_shouldIgnoreUnnamedSplitModules_is_set() {
    ...
    assertThat(logs).containsExactly("The parser will ignore unnamed split packages.");
  }
}
