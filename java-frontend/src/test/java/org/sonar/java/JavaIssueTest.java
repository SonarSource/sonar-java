...
public class JavaIssueTest {
  ...
  DefaultInputProject defaultInputProject = mock(DefaultInputProject.class);
  ...
  public void testIssueCreation() {
    ...
    DefaultIssue newIssue = new DefaultIssue(defaultInputProject, storage);
    DefaultIssue newIssueOnFile = new DefaultIssue(defaultInputProject, storage);
    DefaultIssue newIssueOnLine = new DefaultIssue(defaultInputProject, storage);
  ...
  public void test_addFlow() throws Exception {
    ...
    SensorContext sensorContext = mock(SensorContext.class);
    SensorStorage storage = mock(SensorStorage.class);
    DefaultIssue newIssueEmptyFlow = new DefaultIssue(defaultInputProject, storage);
    DefaultIssue newIssueWithFlow = new DefaultIssue(defaultInputProject, storage);
