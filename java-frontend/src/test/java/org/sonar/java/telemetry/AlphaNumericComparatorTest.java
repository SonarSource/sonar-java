...
class AlphaNumericComparatorTest {
  ...
  private static AbstractStringAssert<?> assertComp(String str) {
  ...
  void test_alpha_numeric_comparator() {
    ...
    assertComp("22abc22abc")
      .isGreaterThan("3abc22abc")
      .isEqualTo("22abc22abc")
      .isLessThan("abc22abc");
    ...
    assertComp("abc123def")
      .isGreaterThan("abc22def")
      .isEqualTo("abc123def")
      .isLessThan("abc99999999def");

    assertComp("abc22abc")
      .isGreaterThan("22abc22abc");

    assertComp("abc22def")
      .isLessThan("abc123def");

    assertComp("abc22v1")
      .isLessThan("abc22v1.12");

    assertComp("abc22v1.6")
      .isLessThan("abc22v1.12");

    assertComp("abc22v2")
      .isGreaterThan("abc22v1.12");
