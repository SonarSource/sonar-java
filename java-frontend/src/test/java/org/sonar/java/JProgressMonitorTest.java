...
class JProgressMonitorTest {
  ...
  void test_set_cancel_does_nothing() {
    JProgressMonitor progressMonitor = new JProgressMonitor(() -> false);
  ...
  void task_related_methods_do_nothing() {
    ...
    JProgressMonitor report = new JProgressMonitor(() -> false, logger, TimeUnit.MILLISECONDS.toMillis(500));
  ...
  void test_simple_report_progress() throws Exception {
    ...
    JProgressMonitor report = new JProgressMonitor(() -> false, logger, TimeUnit.MILLISECONDS.toMillis(250));
  ...
  void test_is_cancelled() throws Exception {
    ...
    JProgressMonitor report = new JProgressMonitor(() -> true, logger, TimeUnit.MILLISECONDS.toMillis(250));
