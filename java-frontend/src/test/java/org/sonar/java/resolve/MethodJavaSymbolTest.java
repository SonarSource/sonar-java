...
public class MethodJavaSymbolTest {
  ...
  public void test_unknowns() {
    MethodVisitor methodVisitor = new MethodVisitor(Sets.newHashSet(21), Sets.newHashSet(32));
    ...
    JavaAstScanner.scanSingleFileForTests(
      ...
      new VisitorsBridge(Collections.singleton(new SubscriptionVisitor() {
        ...
        public void visitNode(Tree tree) {
          ...
          assertThat(JUtils.isOverridable(symbol)).isEqualTo(methodOverridableByLine.get(line));
        }
